/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c968b1e905305ef4263971949bb49787)
...
interface __BaseEnv_Env {
	...
	DRYCMS_SECRET_KEY: string;
	DRYCMS_JWT_ACTIVE_KID: string;
	DRYCMS_BOOTSTRAP_TOKEN: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/server/entry-worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_PAT_KEY" | "GITHUB_REPO" | "GITHUB_BRANCH" | "DRYCMS_SECRET_KEY" | "DRYCMS_JWT_ACTIVE_KID" | "DRYCMS_BOOTSTRAP_TOKEN">> {}
}
