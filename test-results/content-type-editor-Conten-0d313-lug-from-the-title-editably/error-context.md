...
- Name: content-type-editor.spec.ts >> Content Type editor >> SlugField auto-derives the slug from the title, editably
- Location: e2e/content-type-editor.spec.ts:51:3
