...
- Name: content-type-editor.spec.ts >> Content Type editor >> text validation: regex/format mutually exclusive, minLength=0 does not force Required, minLength>0 does
- Location: e2e/content-type-editor.spec.ts:104:3
