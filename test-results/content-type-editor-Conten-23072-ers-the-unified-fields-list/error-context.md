...
- Name: content-type-editor.spec.ts >> Content Type editor >> Dragging a field's handle reorders the unified fields list
- Location: e2e/content-type-editor.spec.ts:225:3
