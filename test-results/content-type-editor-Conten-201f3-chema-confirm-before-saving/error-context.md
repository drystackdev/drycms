...
- Name: content-type-editor.spec.ts >> Content Type editor >> Editing an existing content type shows the apply-schema confirm before saving
- Location: e2e/content-type-editor.spec.ts:190:3
