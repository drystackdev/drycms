...
- Name: content-type-editor.spec.ts >> Content Type editor >> Fields list: system rows have no click-to-edit/Remove, ID has no drag handle, Title does
- Location: e2e/content-type-editor.spec.ts:203:3
