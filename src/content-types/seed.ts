...
const IDS = {
  ...
  systemSettingsBackgroundColor: "system-settings-background-color",
  systemSettingsCardColor: "system-settings-card-color",
  systemSettingsTextColor: "system-settings-text-color",
...
export function defaultContentTypeDefinitions(): ContentTypeDefinition[] {
  ...
  const systemSettings: ContentTypeDefinition = {
    ...
    fields: [
      ...
      {
        id: IDS.systemSettingsBackgroundColor,
        name: "backgroundColor",
        label: "Page background",
        type: "text",
        config: { placeholder: "#f9fafb" },
        validation: { regex: "^#[0-9a-fA-F]{6}$" },
        default: "#f9fafb",
        order: 6,
      },
      {
        id: IDS.systemSettingsCardColor,
        name: "cardColor",
      ...
      {
        id: IDS.systemSettingsTextColor,
        name: "textColor",
        label: "Text",
        type: "text",
        config: { placeholder: "#1c252e" },
        validation: { regex: "^#[0-9a-fA-F]{6}$" },
        default: "#1c252e",
        order: 8,
      },
