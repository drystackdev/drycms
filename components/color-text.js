...
`,_=[`https://picsum.photos/seed/site-carousel-1/480/280`,`https://picsum.photos/seed/site-carousel-2/480/280`,`https://picsum.photos/seed/site-carousel-3/480/280`],v=e=>e({images:e.images().default(_),caption:e.string()});function y({images:r,caption:i}){let[a,o]=e(0),s=r&&r.length>0?r:_,c=Math.min(a,s.length-1);return n(`div`,{className:`carousel`,children:[n(`div`,{className:`carousel__content`,children:[t(`button`,{type:`button`,onClick:()=>o(e=>(e-1+s.length)%s.length),children:`‹`}),t(`img`,{src:s[c],alt:i||`Slide ${c+1}`}),t(`button`,{type:`button`,style:{right:1},onClick:()=>o(e=>(e+1)%s.length),children:`›`})]}),i?t(`p`,{className:`carousel__caption`,children:i}):null]})}var b=m.__fromFile(`carousel`,{label:`Carousel`,description:`An inline image carousel with prev/next controls and an optional caption.`,type:`inline`,props:v,style:g,component:y,requiredInput:!1}),x=e=>e({color:e.string().default(`#e11d48`)});function S({color:e}){return t(`div`,{className:`color-text`,style:{color:e||`#e11d48`},children:t(`slot`,{})})}var C=m.__fromFile(`color-text`,{label:`Colored text`,description:`Wraps nested rich text and changes its color - drop any paragraph/heading/list inside.`,type:`block`,style:`
    .color-text {
